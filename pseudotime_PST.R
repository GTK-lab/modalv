...
## log_sc_time_tpm_messup_bin <- binarizeexp_fit_all(cutoff,
## log_sc_time_tpm_messup[names(bimocondition)[bimocondition],])
...
## hmat_bin <- log_sc_time_tpm_messup_bin[names(hmmcondition)[hmmcondition],]
...
## gplots::heatmap.2(as.matrix(hmat_bin),
##           trace="none",
...
## gplots::heatmap.2(as.matrix(hmat_bin)[,cellorder],
##           trace="none",
